...
public class MediaUtils {
	...
	public static void deleteFile(String path) {
		File file = new File(SystemConstant.XM_CMS_ROOT + path);
		file.delete();
	}
	...
	public static String saveImage(MultipartFile multipartFile, int width,
		...
		String filePath = SystemConstant.XM_CMS_ROOT + "/" + path;
		File file = new File(SystemConstant.XM_CMS_ROOT + "/" + path);
		...
		// baos.writeTo(fos);
		//String tmp_path = PropertyUtils.getValue("xmcms.weburl") + "/" + path;
		return path;
	}
