...
import com.xm.cms.dao.FolderDao;
...
public class FolderService {
	...
	public FolderVo getFolderByarticleId(long articleId) throws FolderNotFoundException {
		FolderVo folder = folderDao.getFolderByarticleId(articleId);
		if (folder == null) {
			throw new FolderNotFoundException("");
		} else {
			logger.debug("目录("+articleId+")中的图片尺寸："+folder.getWidth()+" x "+folder.getHeight());
			return folder;
		}
	}
